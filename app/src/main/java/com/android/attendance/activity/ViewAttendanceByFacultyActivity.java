...
public class ViewAttendanceByFacultyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		attendanceList.add("Roll No. |    Present Status   | Student Name   ");
		...
		for(AttendanceBean attendanceBean : attendanceBeanList)
		{
			...
			if(attendanceBean.getAttendance_session_id() != 0)
			{
				...
				users = studentBean.getStudent_mobilenumber()+".                        "+attendanceBean.getAttendance_status()+"        						"+studentBean.getStudent_firstname()+"  "+studentBean.getStudent_lastname();
			}
			else
			{
