...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	Spinner spinnerbranch,spinneryear,spinnersemester,spinnerSubject;
	String branch = "cse";
	String year = "SE";
	String subject = "SC";

	private String[] branchString = new String[] { "CSE","BCA"};
	private String[] yearString = new String[] {"1st","2nd","3rd","4th"};
	private String[] subjectFinal = new String[] {"Math","Data Structure","C++","Java","Digital Electronics","Algorithm","Physics","Computer Architecture"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//................spinner 1 [select branch spinner]
		...
		//..................spinner 3 [select subject spinner]
